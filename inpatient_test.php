...
footer {
  ...
  <body>
   ...
   <h1>Inpatient Test Registration </h1>
    ...
    <form action="inpatient_test.php" method="POST">
...
$sql1 = "INSERT INTO test (patient_type,test_name,test_amount,test_date,test_result,docid,opid,ipid	) VALUES ('inpatient','$test_one_name',$test_one_amount,'$test_one_date','null','$doctorOneID',NULL,'$IPid')";
$sql2 = "INSERT INTO test (patient_type,test_name,test_amount,test_date,test_result,docid,opid,ipid	) VALUES ('inpatient','$test_two_name',$test_two_amount,'$test_two_date','null','$doctorTwoID',NULL,'$IPid')";
